                  ...
                  <div className="max-w-2xl mx-auto p-3 text-center">
                        <div>
                              ...
                              <div className="text-md text-gray-500 flex flex-col gap-6">
                                    <p>
                                          Welcome to mohammad's Blog! This blog
                                          was created by mohammad karimi as a
                                          personal project to share his thoughts
                                          and ideas with the world. mohammad is
                                          a passionate developer who loves to
                                          write about technology, coding, and
